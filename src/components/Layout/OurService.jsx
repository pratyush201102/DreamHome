      ...
      <section className="mx-auto bg-silverLite px-10 md:px-16 lg:px-20 py-20 pt-20 md:py-16">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="mt-10 lg:mt-0 lg:mx-10">
            ...
            We prioritize your comfort by offering a wide range of homes that suit your needs. Our goal is to ensure a smooth and enjoyable experience throughout your property journey.
